...
const credentialFields: Record<string, Array<{ key: string; label: string; type: string; hint?: string }>> = {
    ...
    mypos: [
        { key: 'client_id',             label: 'Client ID',     type: 'text',     hint: 'Direct Merchant Key or Partner Client ID (starts with client_*)' },
        { key: 'client_secret',         label: 'Client Secret', type: 'password', hint: 'Direct Merchant Secret or Partner Secret (starts with secret_*)' },
        // --- For Partner Integration Only ---
        { key: 'merchant_client_id',     label: 'Merchant Client ID (Optional)',     type: 'text',     hint: 'Only for Partners/Platforms. Starts with cli_*' },
        { key: 'merchant_client_secret', label: 'Merchant Client Secret (Optional)', type: 'password', hint: 'Only for Partners/Platforms. Starts with sec_*' },
        { key: 'partner_id',     label: 'Partner ID (Optional)',     type: 'text', hint: 'mps-p-...' },
        { key: 'application_id', label: 'Application ID (Optional)', type: 'text', hint: 'mps-app-...' },
        { key: 'is_demo',        label: 'Use Demo / Sandbox environment', type: 'checkbox' },
    ],
};
