...
class Config(context: Context) : BaseConfig(context) {
    ...
    var erpUrl: String
        get() = prefs.getString(ERP_URL, "") ?: ""
        set(erpUrl) = prefs.edit().putString(ERP_URL, erpUrl).apply()

    var erpToken: String
        get() = prefs.getString(ERP_TOKEN, "") ?: ""
        set(erpToken) = prefs.edit().putString(ERP_TOKEN, erpToken).apply()
}
